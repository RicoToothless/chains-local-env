...
```
$ helm upgrade --install postrges --version 10.13.15 -f k8s/postgres-values.yaml bitnami/postgresql
$ helm upgrade --install chainlink --version 0.2.10 -f k8s/chainlink-values.yaml vulcanlink/chainlink
```
